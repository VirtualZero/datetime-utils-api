...
def subtract_time():
    ...
    if valid_datetime == "":
        try:
            valid_datetime = pendulum.parse(
                data['timestamp']).in_timezone('UTC')
    ...
    converted_timestamp = valid_datetime.subtract(
        days=data['days'],
        hours=data['hours'],
    ...
    if not only_elements or only_elements.lower() != 'true':
        response_payload['UTC'] = {
            ...
            'human_readable': valid_datetime.subtract(
                days=data['days'],
                hours=data['hours'],
                minutes=data['minutes'],
                seconds=data['seconds'],
    ...
    if timezones:
        for timezone in timezones:
            subtraction_in_tz = converted_timestamp.in_timezone(timezone)

            if not only_elements or only_elements.lower() != 'true':
                response_payload[timezone] = {
                    'timezone_aware': str(subtraction_in_tz),
                    'iso_8601_format': subtraction_in_tz.to_iso8601_string(),
                    'atom': subtraction_in_tz.to_atom_string(),
                    'cookie': subtraction_in_tz.to_cookie_string(),
                    'rss': subtraction_in_tz.to_rss_string(),
                    'w3c': subtraction_in_tz.to_w3c_string(),
                    'human_readable': valid_datetime.subtract(
                        days=data['days'],
                        hours=data['hours'],
                        minutes=data['minutes'],
                    ...
                    'datetime': {
                        'datetime_string': subtraction_in_tz.to_datetime_string(),
                        'date_string': subtraction_in_tz.to_date_string(),
                        'time_string': subtraction_in_tz.to_time_string()
                    },

                    'rfc': {
                        'rfc822': subtraction_in_tz.to_rfc822_string(),
                        'rfc850': subtraction_in_tz.to_rfc850_string(),
                        'rfc1036': subtraction_in_tz.to_rfc1036_string(),
                        'rfc1123': subtraction_in_tz.to_rfc1123_string(),
                        'rfc2822': subtraction_in_tz.to_rfc2822_string(),
                        'rfc3339': subtraction_in_tz.to_rfc3339_string()
                    },

                    'epoch': {
                        'float': subtraction_in_tz.float_timestamp,
                        'integer': subtraction_in_tz.int_timestamp
                    },
                ...
                response_payload[timezone]['elements'] = {
                    'date': {
                        'day': {
                            ...
                            'day_of_year': subtraction_in_tz.day_of_year

                        },

                        'week': {
                            'week_of_year': subtraction_in_tz.isocalendar()[1],
                            'week_of_month': subtraction_in_tz.week_of_month
                        },
                        ...
                        'quarter': subtraction_in_tz.quarter
                    },
                    ...
                    'time': {
                        ...
                        'timezone': subtraction_in_tz.timezone_name
                    },
